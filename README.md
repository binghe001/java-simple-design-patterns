...
* java-simple-design-factorymethod: 工厂方法模式（FactotyMethod）
* java-simple-design-builder: 建造者模式（Builer）
* java-simple-design-prototype:原型模式（Prototype）
* java-simple-design-adapter: 适配器模式（Adapter）
* java-simple-design-decorator: 装饰模式（Decorator）
* java-simple-design-facade: 外观模式（Facade）
* java-simple-design-proxy: 代理模式（Proxy）
* java-simple-design-bridge: 桥接模式（Bridge）
* java-simple-design-composite: 组合模式（Composite）
* java-simple-design-flyweight: 享元模式(Flyweight)
* java-simple-design-cor: 责任链模式(COR)
* java-simple-design-command: 命令模式(Command)
* java-simple-design-interpreter: 解析器模式（Interpreter）
* java-simple-design-interator: 迭代器模式（Interator）
* java-simple-design-mediator: 中介者模式（Mediator）
* java-simple-design-memento: 备忘录模式（Memento）
* java-simple-design-observer: 观察者模式（Observer）
* java-simple-design-state: 状态模式（State）
* java-simple-design-strategy: 策略模式（Strategy）
* java-simple-design-templatemethod: 模板方法（TemplateMethod）
* java-simple-design-visitor: 访问者模式（Visitor）
